...
import tk.minas.clients.ad.AdController;
import tk.minas.clients.ad.AdModel;
import tk.minas.clients.ad.AdView;
import tk.minas.clients.backDoor.BackDoorController;
import tk.minas.clients.backDoor.BackDoorModel;
import tk.minas.clients.backDoor.BackDoorView;
import tk.minas.clients.cashier.CashierController;
import tk.minas.clients.cashier.CashierModel;
import tk.minas.clients.cashier.CashierView;
import tk.minas.clients.collection.CollectController;
import tk.minas.clients.collection.CollectModel;
import tk.minas.clients.collection.CollectView;
...
import tk.minas.clients.music.MusicClient;
import tk.minas.clients.shopDisplay.DisplayController;
import tk.minas.clients.shopDisplay.DisplayModel;
import tk.minas.clients.shopDisplay.DisplayView;
import tk.minas.clients.warehousePick.PickController;
import tk.minas.clients.warehousePick.PickModel;
import tk.minas.clients.warehousePick.PickView;
import tk.minas.middle.LocalMiddleFactory;
...
class Main {
  ...
  public void startMusicGUI_MVC() {
    Dimension pos = PosOnScrn.getPos();
    MusicClient mc = new MusicClient(pos);
    mc.run();
  }

  public void startAdGUI_MVC(MiddleFactory mlf) {
    JFrame  window = new JFrame();

    window.setTitle( "AD Client MVC");
    window.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
    Dimension pos = PosOnScrn.getPos();

    AdModel model      = new AdModel(mlf);
    AdView view        = new AdView( window, mlf, pos.width, pos.height );
