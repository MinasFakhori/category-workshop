...
import tk.minas.dbAccess.StockR;
...
public class      R_StockR extends    java.rmi.server.UnicastRemoteObject implements RemoteStockR_I {
  ...
  public ArrayList<Product> getAll() throws SQLException {
    return aStockR.getAll();
  }

  @Override
  public Product getDetailsName(String name) throws RemoteException, StockException {
    return aStockR.getNameDetails(name);
  }
