...
public class CashierView implements Observer
{
  ...
  private final JButton theRemoveBtn = new JButton(REMOVE);
  ...
  public CashierView(  RootPaneContainer rpc,  MiddleFactory mf, int x, int y  )
  {
    ...
    theBtCheck.addActionListener(                   // Call back code
      e -> cont.doCheck( theInput.getText() , Integer.parseInt(quantity.getText())) );
    ...
    theRemoveBtn.setBounds( 16, 25+60*3, 80, 40 );   // Clear Button
    theRemoveBtn.addActionListener(                  // Call back code
            e -> {
              try {
    ...
    quantity.setBounds(350, 50 , 35 , 40 );
    quantity.setText("1");
    cp.add(quantity);
