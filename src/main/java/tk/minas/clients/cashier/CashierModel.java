package tk.minas.clients.cashier;
...
public class CashierModel extends Observable
{
  ...
  public void doRemove(String productNumber) throws StockException {
    String removedItem = "";
    for (int i = 0; i < theBasket.size(); i++) {
      if (theBasket.get(i).getProductNum().equals(productNumber)) {
        removedItem = theBasket.get(i).getDescription() + " removed";
        theStock.addStock(theBasket.get(i).getProductNum().trim(), 1);
      ...
      setChanged(); notifyObservers(removedItem);
    }
  }
